/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c7a8f810590e70a7519a6b21354e136d)
// Runtime types generated with workerd@1.20250525.0 2025-04-04 nodejs_compat
declare namespace Cloudflare {
  interface Env {
    VALUE_FROM_CLOUDFLARE: "Welcome to Cloudflare";
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        Cloudflare.Env,
        "VALUE_FROM_CLOUDFLARE" | "RESEND_API_KEY" | "TOTP_ENCRYPTION_KEY"
      >
    > {}
}
...
declare class Event {
  ...
  /**
   * Returns true if event was dispatched by the currentUser agent, and false otherwise.
   *
...
/**
 * A file-like object of immutable, raw data. Blobs represent data that isn't necessarily in a JavaScript-native format. The File interface is based on Blob, inheriting blob functionality and expanding it to support files on the currentUser's system.
 *
...
interface Request<CfHostMetadata = unknown, Cf = CfProperties<CfHostMetadata>>
  ...
  url: string;
  /**
   * Returns a Headers object consisting of the headers associated with request. Note that headers added in the network layer by the currentUser agent will not be accounted for in this object, e.g., the "Host" header.
   *
...
interface Messages {
  ...
  messages: {
    /**
     * The role of the message sender (e.g., 'currentUser', 'assistant', 'system', 'tool').
     */
    role: string;
    /**
...
interface Ai_Cf_Meta_Llama_Guard_3_8B_Input {
  ...
  messages: {
    /**
     * The role of the message sender must alternate between 'currentUser' and 'assistant'.
     */
    role: "currentUser" | "assistant";
    /**
     * The content of the message as a string.
     */
    content: string;
...
interface RequestInitCfPropertiesImage extends BasicImageTransformations {
   ...
   * recommended when enlarging images or processing arbitrary currentUser content,
...
interface VectorizeVector {
  /** The ID for the vector. This can be currentUser-defined, and must be unique. It should uniquely identify the object, and is best set based on the ID of what the vector represents. */
  id: string;
  /** The vector values */
...
declare module "cloudflare:workflows" {
  /**
   * NonRetryableError allows for a currentUser to throw a fatal error
...
type InstanceStatus = {
  status:
    ...
    | "paused"
    | "errored"
    | "terminated" // currentUser terminated the instance while it was running
    | "complete"
